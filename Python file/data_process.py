...
def datatransfer(file, subfile,name):
    text_list = []
    protein_name = []
    protein_link = []
    line_count = []
    newlist= listdirs(file)
    sub_folders = [name for name in os.listdir(subfile) if os.path.isdir(os.path.join(subfile, name))]
...
host_subfile = r'C:\Users\Administrator\Desktop\IMSP-Parser-master\IMSP-Parser-master\data\protein data\host protein'

datatransfer(hostfile, host_subfile, "host.json")

virusfile= r'C:\Users\Administrator\Desktop\IMSP-Parser-master\IMSP-Parser-master\data\protein data\virus protein'
virus_subfile = r'C:\Users\Administrator\Desktop\IMSP-Parser-master\IMSP-Parser-master\data\protein data\virus protein'

datatransfer(virusfile, virus_subfile, "virus.json")